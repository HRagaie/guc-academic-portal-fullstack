...
const checkRequestedDay = async (day, memberId) => {
  ...
  const promisesArray = []
  promisesArray.push(checkDayInRange(sickRequest, day, memberId))
  promisesArray.push(checkDayInRange(maternityRequest, day, memberId))
  promisesArray.push(checkDayInRange(annualLeaveRequest, day, memberId))
  promisesArray.push(checkDay(AccidentalLeaveRequest, day, memberId))
  const [
    checkSick,
    checkMaternity,
    checkAnnual,
