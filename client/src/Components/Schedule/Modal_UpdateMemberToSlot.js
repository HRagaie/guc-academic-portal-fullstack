...
function Modal_UpdateMemberToSlot(props) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    let newMemberId = memberid[dropDownValue];
    let assignmentId = props.slotid;
    axios.defaults.baseURL = "http://localhost:5000";
    axios
      .put(
        "/slotAssignment/updateSlotMemberAssign",
        {
          assignmentId,
          newMemberId,
        },
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-vcenter">
          <div style={{ color: "#17a2b8" }}>Update Staff On Course Slot</div>
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
...
export default Modal_UpdateMemberToSlot;
