...
import CreateAnnualRequest from '../Requests/CreateAnnualRequest'
...
export default function AccidentalRequests() {
  ...
  const handleCancel = (id, index) => {
    axios({
      method: 'POST',
      url: `${backendLink}/request/cancelAnnualLeaveRequest`,
      headers: {
        'auth-token': token,
      },
      data: {
  ...
  const handleAccept = (id, index) => {
    ...
    axios({
      method: 'POST',
      url: `${backendLink}/request/acceptAnnualLeaveRequest`,
      headers: {
        'auth-token': token,
      },
      data: {
  ...
  const handleReject = (id, comment) => {
    ...
    axios({
      method: 'POST',
      url: `${backendLink}/request/rejectAnnualLeaveRequest`,
      headers: {
        'auth-token': token,
      },
      data: reqBody,
  ...
  useEffect(() => {
    if (requestState === 'sent') {
      ...
      axios({
        method: 'POST',
        url: `${backendLink}/request/viewMyAnnualRequests`,
        headers: {
          'auth-token': token,
        },
        data: reqBody,
      ...
      axios({
        method: 'POST',
        url: `${backendLink}/request/viewAnnualRequestsInDep`,
        headers: {
          'auth-token': token,
        },
        data: reqBody,
  ...
  return (
    <div className='main-page'>
      <p className='request-heading'>Annual Requests</p>
