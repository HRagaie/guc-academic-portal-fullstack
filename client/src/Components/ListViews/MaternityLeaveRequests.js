...
import CreateMaternityRequest from '../Requests/CreateMaternityRequest'
...
export default function MaternityLeaveRequests() {
  ...
  const [maternityRequests, setMaternityRequests] = useState([])
  ...
  const handleCancel = (id) => {
    axios({
      method: 'POST',
      url: `${backendLink}/request/cancelMaternityLeaveRequest`,
      headers: {
        'auth-token': token,
      },
      data: {
  ...
  const handleAccept = (id) => {
    axios({
      method: 'POST',
      url: `${backendLink}/request/acceptMaternityLeave`,
      headers: {
        'auth-token': token,
      },
      data: {
  ...
  const handleReject = (id, comment) => {
    ...
    axios({
      method: 'POST',
      url: `${backendLink}/request/rejectMaternityLeave`,
      headers: {
        'auth-token': token,
      },
      data: reqBody,
  ...
  useEffect(() => {
    if (requestState === 'sent') {
      ...
      axios({
        method: 'POST',
        url: `${backendLink}/request/viewMyMaternityRequests`,
        headers: {
          'auth-token': token,
        },
        data: reqBody,
      ...
      axios({
        method: 'POST',
        url: `${backendLink}/request/viewMaternityRequestsInDep`,
        headers: {
          'auth-token': token,
        },
        data: reqBody,
  ...
  return (
    <div className='main-page'>
      <p className='request-heading'>Maternity Requests</p>
